          ...
          <StyledSearchbar>
            <Autocomplete
              ...
              renderOption={(props, option, { inputValue }) => {
                ...
                // match may return undefined when inputValue is empty — guard it
                const matchedTitle = match(safeTitle, inputValue) || [];
                const matchedPath = match(safePath, inputValue) || [];

                const partsTitle = parse(safeTitle, matchedTitle);

                const partsPath = parse(safePath, matchedPath);
