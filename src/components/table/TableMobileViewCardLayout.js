...
function TableMobileViewCardLayout({ data = [], onEditRow, onDeleteRow, onSelectRow, selected = [] }) {
...
TableMobileViewCardLayout.propTypes = {
...
export default TableMobileViewCardLayout;
